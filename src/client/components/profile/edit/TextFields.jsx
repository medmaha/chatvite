        ...
        <div ref={containerRef}>
            ...
            <div className="flex flex-col gap-1 mb-3">
                ...
                <div className="w-full">
                    ...
                    />
                    <p className="text-sm tracking-wide truncate px-1 text-orange-400 h-max py-0 m-0">
                        Changing your username might cause unintended side
                        effects.
                    </p>
                </div>
            </div>
            <div className="flex flex-col gap-1 mb-3">
                ...
                <div className="w-full">
                    ...
                    />
                    <p className="text-sm tracking-wide truncate px-1 text-orange-400">
                        Note: you&apos;ll have to verify your email after
                        changing it.
                    </p>
                </div>
            </div>
