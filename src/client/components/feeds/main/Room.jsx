...
export default function Room({ room }) {
    ...
    return (
        <div className="bg-gray-700 p-3 rounded-md mb-2">
            ...
            <div className="mt-2 px-1 cursor-pointer" onClick={navigateToRoom}>
                <h2 className="text-xl font-semibold tracking-wide">
                    {room.name}
                </h2>
                <p className="truncate text-sm text-gray-300 font-semibold tracking-wide">
                    {room.description}
                </p>
            </div>
            ...
            <div className="flex justify-between items-center">
                <div className="">
                    <button className="inline-flex items-center gap-2 cursor-default">
                ...
                <div className="">
                    <button className="px-3 py-2 rounded-full  transition-[color,outline] bg-gray-800 text-gray-300 hover:text-blue-400 hover:outline-blue-400 hover:outline-[1px] hover:outline">
                        {room.topic.name}
                    </button>
                </div>
            </div>
